...
public final class FindMeetingQueryTest {
  ...
  private static final String PERSON_C = "Person C - Optional";
  ...
  @Test
  public void meetWithOptionalAttendee() {
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void optionalAttendeesCanMeet() {
    // Have two optionals, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----B----|
    // Day     : |---------------------|
  ...
  @Test
  public void optionalAttendeesCannotMeet() {
    // Have two optional attendees busy all day
    //
    // Events  : |----------A----------|
    //           |----------B----------|
    // Day     : |---------------------|
